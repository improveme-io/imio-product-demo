    ...
    <>
      ...
      <main className="container flex min-h-screen w-full flex-col gap-x-8 bg-stone-50 px-8 py-8 sm:px-16 md:pl-32">
        ...
        <div className="mb-20 md:w-4/6">
          ...
          <p>
            The data controller for the personal data we collect through the use
            of our software as a service solution is improveme.io, a privately
            maintained website.
          </p>

          <h2 className="my-12 font-serif text-xl">Types of Data We Collect</h2>
          ...
          <ul className="list-disc">
            ...
            <li className="ml-4 mt-4">
              Payment information, such as your billing address and credit card
              information
            </li>
            <li className="ml-4 mt-4">
            ...
            <li className="ml-4 mt-4">
              Other information you choose to provide to us, such as feedback or
              survey responses
            </li>
          </ul>

          <h2 className="my-12 font-serif text-xl">How We Collect Your Data</h2>

          <p>We may collect your personal data through the following means:</p>
          ...
          <p>
            ...
            your personal data from unauthorized access, disclosure, or misuse.
            We use industry-standard encryption technologies to secure your data
            when it is transmitted over the internet.
          </p>

          <h2 className="my-12 font-serif text-xl">Your Rights and Choices</h2>
          ...
          <p>
            ...
            personal data, please contact us at legal@improveme.io We may update
            ...
            changes to this Privacy Policy by posting a notice on our website or
